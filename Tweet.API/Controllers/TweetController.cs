...
namespace Tweet.API.Controllers
{
    ...
    public class TweetController : Controller
    {
        ...
        [HttpGet]
        [Route("user/searchbbox/{username}")]
        public JsonResult SearchLikeUserTweet(string username)
        {
            List<TweetModel> tweetsByUserId = new List<TweetModel>();
            ...
            try
            {
                tweetsByUserId = _tweetService.GetAllTweetSearchUser(username);
        ...
        [HttpPost("Updatetweet")]
        public JsonResult UpdateTweet([FromBody] TweetModel tweetModel)
        {
            bool status = false;
            string response;
            try
