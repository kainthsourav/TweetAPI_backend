...
namespace TA.Service.Implementation
{
    public class UserService : IUserService
    {
        ...
        {
            UserModel isEmailExists = new UserModel();
            ...
            try
            {
                ...
                isEmailExists = CheckUserExists(user.email);
                isUserExists = CheckUserExists(user.username);
                if (isUserExists == null && isEmailExists == null)
                {
